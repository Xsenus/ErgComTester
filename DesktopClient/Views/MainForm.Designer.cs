...
partial class MainForm
{
    ...
    private Control CreateTopLayout()
    {
        ...
        rightLayout.Controls.Add(updatesGroup, 0, 1);
        rightLayout.Controls.Add(new Panel { Dock = DockStyle.Fill, Margin = new Padding(0), BackColor = Color.Transparent }, 0, 2);
