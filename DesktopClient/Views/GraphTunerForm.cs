    ...
    public partial class GraphTunerForm : Form
    {
        ...
        private void ApplyPreset(PresetDto p)
        {
            ...
            o.DottedDashLengthPx = ErgReportBuilder.GraphRenderOptions.NormalizeDottedLength(
                ...
                defaults.DottedDashLengthPx);
            o.DottedGapLengthPx = ErgReportBuilder.GraphRenderOptions.NormalizeDottedLength(
                p.DottedGapLengthPx > 0f ? p.DottedGapLengthPx : defaults.DottedGapLengthPx,
                defaults.DottedGapLengthPx);
